...
import structures.basic.cards.CardEffect;
...
public class CardClicked implements EventProcessor{
	...
	public void processEvent(ActorRef out, GameState gameState, JsonNode message) {
		...
		// Creates a CardEffect object for the clicked card, using the game state and card position
		CardEffect cardAction = new CardEffect(gameState, handPosition);
